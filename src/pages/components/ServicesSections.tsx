        ...
        <div className="max-w-screen-xl mx-auto px-5 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {SERVICES.map((s, i) => {
              ...
              return (
                <div key={i}
                  className="relative rounded-2xl overflow-hidden group transition-all duration-300 hover:-translate-y-1.5 flex flex-col"
                  ...
                  <div className="relative h-44 overflow-hidden shrink-0">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 px-4 pb-3 pt-6"
                      ...
                      <div className="flex items-end justify-between">
                        <h3 className="font-black text-sm uppercase leading-snug tracking-wide text-white drop-shadow">{s.title}</h3>
                        <span className="text-base font-black leading-none whitespace-nowrap ml-2"
