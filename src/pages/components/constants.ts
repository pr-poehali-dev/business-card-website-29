...
export const SERVICES = [
  ...
  { icon: "Building2", title: "Строительство ангаров", desc: "Каркасные металлические ангары для производства, хранения, сельского хозяйства. Под ключ с фундаментом.", price: "по запросу" },
