    ...
    <div className="min-h-screen overflow-x-hidden" style={{ background: C.bg, color: "#fff" }}>
      ...
      <section className="relative pt-[70px] min-h-[60vh] flex items-end pb-16" style={{ background: C.bgDark }}>
        <div className="absolute inset-0">
          <img src={data.heroImg} alt={data.title} className="w-full h-full object-cover opacity-25" />
          <div className="absolute inset-0" style={{ background: `linear-gradient(to bottom, rgba(15,20,34,0.5), ${C.bgDark})` }} />
        </div>
